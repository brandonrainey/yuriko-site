...
const DailyLife = () => {
  ...
  const lifeImages = [
    { srcAVIF: flowersAvif, srcWEBP: flowersWebp, srcJPG: flowersJpg, alt: 'Flowers in Kamakura' },
    { srcAVIF: fujiAvif, srcWEBP: fujiWebp, srcJPG: fujiJpg, alt: 'mount fuji in tokyo' },
    { srcAVIF: jinjaAvif, srcWEBP: jinjaWebp, srcJPG: jinjaJpg, alt: 'shrine in kamakura' },
    { srcAVIF: sunflowerAvif, srcWEBP: sunflowerWebp, srcJPG: sunflowerJpg, alt: 'sunflower' },
  ];
